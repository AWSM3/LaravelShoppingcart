...
class CartItem implements Arrayable, Jsonable
{
    ...
    /**
     * Discount rules (coupon/dicount/promo codes or instances).
     *
     * @var mixed
     */
    public $discount;
     ...
     */
    public function __construct($id, $name, $price, array $options = [], $discount = null)
    {
        if(empty($id)) {
    ...
    public function updateFromArray(array $attributes)
    {
        ...
        $this->priceTax = $this->price + $this->tax;
        $this->discount = array_get($attributes, 'discount', $this->discount);
    ...
    public static function fromArray(array $attributes)
    {
        ...
        $discount = array_get($attributes, 'discount', null);

        return new self($attributes['id'], $attributes['name'], $attributes['price'], $options, $discount);
    }
     ...
     * @return \Gloudemans\Shoppingcart\CartItem
     */
    public static function fromAttributes($id, $name, $price, array $options = [], $discount = null)
    {
        return new self($id, $name, $price, $options, $discount);
    }
