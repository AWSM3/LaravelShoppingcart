...
class CartItemTest extends TestCase
{
    ...
    {
        $cartItem = new CartItem(1, 'Some item', 10.00, ['size' => 'XL', 'color' => 'red'], 15);
    ...
    public function it_can_be_cast_to_json()
    {
        ...
        $json = '{"rowId":"07d5da5550494c62daf9993cf954303f","id":1,"name":"Some item","qty":2,"price":10,"options":{"size":"XL","color":"red"},"discount":15,"tax":0,"subtotal":20}';
